import XCTest
@testable import Lightdim

@MainActor
final class LightdimStoreTests: XCTestCase {
    var store: LightdimStore!
    ...
    func testSeedDataLoadsBelowFreeLimit() throws {
        XCTAssertLessThan(store.entries.count, LightdimStore.freeLimit)
    }
    ...
    func testAddEntryIncreasesCount() throws {
        ...
        store.add(LightdimEntry(value1: "10", value2: "2"))
    ...
    func testFreeLimitBlocksAdditionalEntries() throws {
        for i in 0..<(LightdimStore.freeLimit + 5) {
            store.add(LightdimEntry(value1: "\(i)", value2: ""))
        }
        XCTAssertEqual(store.entries.count, LightdimStore.freeLimit)
    ...
    func testProBypassesFreeLimit() throws {
        ...
        XCTAssertGreaterThan(store.entries.count, LightdimStore.freeLimit)
    }

    func testUpdateEntryChangesValue() throws {
        store.add(LightdimEntry(value1: "1", value2: ""))
